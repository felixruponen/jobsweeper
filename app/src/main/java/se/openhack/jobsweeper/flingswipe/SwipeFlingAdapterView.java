package se.openhack.jobsweeper.flingswipe;
...
public class SwipeFlingAdapterView extends BaseFlingAdapterView {
    ...
    private se.openhack.jobsweeper.flingswipe.FlingCardListener flingCardListener;
    ...
    */
    private void setTopView() {
        if(getChildCount()>0){
            ...
            if(mActiveCard!=null) {
                ...
                flingCardListener = new se.openhack.jobsweeper.flingswipe.FlingCardListener(mActiveCard, mAdapter.getItem(0),
                        ROTATION_DEGREES, new se.openhack.jobsweeper.flingswipe.FlingCardListener.FlingListener() {
                            ...
                            @Override
                            public void onMoveBeyondLeftBorder() {
                                if(mActiveCard != null) {
                                    mFlingListener.onMoveBeyondLeftBorder(mActiveCard);
                                }
                            }
                            ...
                            public void onMoveCenter() {
                                if(mActiveCard != null) {
                                    mFlingListener.onMoveCenter(mActiveCard);
                                }
                            }

                            @Override
                            public void onMoveBeyondRightBorder() {
                                if(mActiveCard != null) {
                                    mFlingListener.onMoveBeyondRightBorder(mActiveCard);
                                }
                            }
    ...
    public interface onFlingListener {
        ...
        void onMoveBeyondLeftBorder(View view);
        void onMoveBeyondRightBorder(View view);
        void onMoveCenter(View view);
